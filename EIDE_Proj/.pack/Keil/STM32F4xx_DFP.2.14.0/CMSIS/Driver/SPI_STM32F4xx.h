...
#error "::Device:STM32Cube Framework: not selected in RTE"
     ...
     (RTE_SPI1 == 0) && (RTE_SPI2 == 0) && (RTE_SPI3 == 0) && (RTE_SPI4 == 0) && (RTE_SPI5 == 0) && (RTE_SPI6 == 0))
...
#define MX_SPI6_NSS_GPIO_AF    GPIO_AF5_SPI6
      ...
      defined(RTE_Drivers_SPI5) ||  \
      defined(RTE_Drivers_SPI6)) && \
     (!defined(MX_SPI1)) && (!defined(MX_SPI2)) && (!defined(MX_SPI3)) && (!defined(MX_SPI4)) && (!defined(MX_SPI5)) && (!defined(MX_SPI6)))
