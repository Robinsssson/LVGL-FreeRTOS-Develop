...
#error "::Device:STM32Cube Framework: not selected in RTE"
     ...
     (RTE_USART1 == 0) && (RTE_USART2 == 0) && (RTE_USART3 == 0) && (RTE_UART4 == 0) && (RTE_UART5 == 0) && (RTE_USART6 == 0) && (RTE_UART7 == 0) && (RTE_UART8 == 0) && (RTE_UART9 == 0) && (RTE_UART10 == 0))
...
#define DMA_PRIORITY(x)   ((x == 0) ? DMA_PRIORITY_LOW : (x == 1) ? DMA_PRIORITY_MEDIUM \
...
#define MX_UART10_RX_GPIO_AF    GPIO_AF11_UART10
      ...
      defined(RTE_Drivers_UART9) ||   \
      defined(RTE_Drivers_UART10)) && \
     (!defined(MX_USART1)) && (!defined(MX_USART2)) && (!defined(MX_USART3)) && (!defined(MX_UART4)) && (!defined(MX_UART5)) && (!defined(MX_USART6)) && (!defined(MX_UART7)) && (!defined(MX_UART8)) && (!defined(MX_UART9)) && (!defined(MX_UART10)))
