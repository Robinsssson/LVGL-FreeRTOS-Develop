...
#error "::Device:STM32Cube Framework: not selected in RTE"
     ...
     (RTE_I2C1 == 0) && (RTE_I2C2 == 0) && (RTE_I2C3 == 0))
...
#define DMA_PRIORITY(x)          ((x == 0) ? DMA_PRIORITY_LOW : ((x == 1) ? DMA_PRIORITY_MEDIUM : ((x == 2) ? DMA_PRIORITY_HIGH : DMA_PRIORITY_VERY_HIGH)))
...
#define MX_I2C3_SDA_GPIO_AF GPIO_AF4_I2C3
      ...
      defined(RTE_Drivers_I2C2) ||  \
      defined(RTE_Drivers_I2C3)) && \
     (!defined(MX_I2C1)) && (!defined(MX_I2C2)) && (!defined(MX_I2C3)))
