...
static lv_obj_t* page1_btn_setting_mode;
...
static void btn_press_3(lv_event_t* e)
{
    page_callback(page_list, PAGE1_INIT, PAGE_SETTING_INIT, LV_SCR_LOAD_ANIM_NONE);
}
...
void page1_init(lv_obj_t* root, cJSON** message)
{
    ...
    page1_btn_setting_mode = lv_btn_create(root);
    lv_obj_set_size(page1_btn_setting_mode, 242, 68);
    lv_obj_align(page1_btn_setting_mode, LV_ALIGN_CENTER, 0, 120);
    lv_obj_add_event_cb(page1_btn_setting_mode, btn_press_3, LV_EVENT_RELEASED, NULL);
    ...
    // “设置”标签
    label2 = lv_label_create(page1_btn_setting_mode);
    lv_label_set_text(label2, "Setting");
    lv_obj_align_to(label2, page1_btn_setting_mode, LV_ALIGN_CENTER, 0, 0);
    ...
    lv_obj_add_style(page1_btn_setting_mode, &style_obj, 0);
}
